...
## My Decision Focus
This app is specifically designed to help me decide on which new hobby to take on based on several carefully chosen factors, including:
...
* If the combined points are between 19 and 40, then the user will receive a “Save for later!” message. This indicates the selected hobby is not a good match for the time being. But this does not mean it will remain so in a month or year.
...
… the app produces this specific output:
    ...
    Give it a try
	Based on the selected options, this activity could go either way, being or not being a good fit. Try it for a few days and decide afterward.
**Example 3: Try Again**
...
… the app produces this specific output:
	...
	Save for Later
    Based on the selection options, this activity is not the best fit for the moment. Select another and try this hobby again at a later date.
